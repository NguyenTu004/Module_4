...
import com.example.token.rest.CustomAccessDeniedHandler;
import com.example.token.rest.JwtAuthenticationTokenFilter;
import com.example.token.rest.RestAuthenticationEntryPoint;
...
@Configuration
@EnableWebSecurity
@ComponentScan("com.example.token")
public class SecurityConfig extends WebSecurityConfigurerAdapter {

    @Bean
    public JwtAuthenticationTokenFilter jwtAuthenticationTokenFilter() {
        //để thực hiện filter request(validate)
    ...
    public CustomAccessDeniedHandler customAccessDeniedHandler() {
        //xử lý các request mà không có quyền
